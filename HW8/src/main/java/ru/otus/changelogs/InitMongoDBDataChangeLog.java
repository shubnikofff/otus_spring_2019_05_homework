...
public class InitMongoDBDataChangeLog {
	...
	public void initComments(MongoTemplate template) {
		template.save(new Comment("User #1", "Very good", books.get(0)));
		template.save(new Comment("User #2", "Interesting book", books.get(0)));
		template.save(new Comment("User #3", "Almost fell asleep", books.get(0)));
		template.save(new Comment("User #1", "I recommend reading", books.get(1)));
		template.save(new Comment("User #2", "Boring", books.get(1)));
