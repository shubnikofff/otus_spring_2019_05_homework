...
public class InitMongoDBDataChangeLog {
	...
	public void initComments(MongoTemplate template) {
		template.save(new Comment("Martin Fowler", "I'd rather read something about computer science than that.", books.get(0)));
		template.save(new Comment("John R. R. Tolkien", "Excellent book! I recommend everyone to read.", books.get(0)));
		template.save(new Comment("John R. R. Tolkien", "Almost fell asleep", books.get(1)));
		template.save(new Comment("Martin Fowler", "This book is a classic, you should read through it and it should sit on your bookshelf.", books.get(1)));
	}
}
